...
class PacMan:
	...
	def draw(self, surface):
		...
		# Start
		pygame.draw.line(surface, Color.green, center, (centerX + Sx, centerY - Sy), 3)
		#End
		pygame.draw.line(surface, Color.goofy_red, center, (centerX + Ex, centerY - Ey), 3)
...
def main():
	...
	pacmen[1].orientation = math.pi / 8 # Should face east with a tilt north.
