...
class PacMan:
	...
	def draw(self, surface):
		...
		center = (self.left + half(width), self.top + half(height))
		...
		if self.direction == Direction.left:
			start_radians = start_radians - math.pi  # This actually swaps sides. Convenient!
		...
		if self.direction in Direction.x_axis:
			...
			if self.direction == Direction.down:
				pygame.draw.arc(surface, self.color, rect, 0, math.pi, 3)
				pygame.draw.arc(surface, self.color, rect, math.pi, 1.5*math.pi - start_radians, 3)
				pygame.draw.arc(surface, self.color, rect, 1.5*math.pi + start_radians, 2*math.pi, 3)

				pygame.draw.line(surface, self.color, center, (centerX + mouth_y, centerY + mouth_x), 3)
				pygame.draw.line(surface, self.color, center, (centerX - mouth_y, centerY + mouth_x), 3)
			else:
				pygame.draw.arc(surface, self.color, rect, math.pi, 2*math.pi, 3)
				pygame.draw.arc(surface, self.color, rect, 0, 0.5*math.pi - start_radians, 3)
				pygame.draw.arc(surface, self.color, rect, 0.5*math.pi + start_radians, math.pi, 3)
				pygame.draw.line(surface, self.color, center, (centerX - mouth_y, centerY - mouth_x), 3)
				pygame.draw.line(surface, self.color, center, (centerX + mouth_y, centerY - mouth_x), 3)
...
def main():
	...
	pacmen[2].colorize(Color.dope_blue_ultralight)

	pacmen[3].colorize(Color.green)
	pacmen[3].chomping = True
	pacmen[3].direction = Direction.down
