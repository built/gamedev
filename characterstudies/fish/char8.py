...
class Tail:
	...
	def draw(self, surface, center, fish, width):
		...
		if fish.direction in Direction.x_axis:
			...
			fin_height = 25
			fin_width = 25
			tailbone = (centerX - ((width/2) * direction_adjustment + 10 * self.wiggles[self.wiggle_step]), centerY)
			...
			if self.wiggle_step == 3:
				self.wiggle_step = 0 # reset
