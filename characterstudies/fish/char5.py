...
class Character:
	...
	def draw_eyes(self, surface, position):
		...
		if self.direction in Direction.x_axis:
			...
			pupil_color = (255, 0, 0) if self.direction_changed else (0, 0, 0)
			...
			pygame.draw.circle(surface, pupil_color, (centerX + eyeball_offset + pupil_offset , centerY - 37), 5)
...
def main():
	...
	fish = Character((0, 600), dimensions)
